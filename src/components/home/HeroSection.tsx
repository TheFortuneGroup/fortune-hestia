    ...
    <div className="relative min-h-screen flex items-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 md:gap-12">
          ...
          <div className="lg:col-span-3 text-white animate-fade-in text-center lg:text-left">
            ...
            <div className="flex flex-col md:flex-row justify-center lg:justify-start gap-4 mb-8 md:mb-12">
              <Button className="bg-gold hover:bg-gold-light text-navy-dark rounded-md px-6 py-6 text-lg flex items-center justify-center gap-2 shadow-lg shadow-gold/20 w-full md:w-auto">
                Schedule a Visit
                <ArrowRight size={18} />
              </Button>
              <Button 
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-4 text-gray-300">
              <div className="bg-gold/10 backdrop-blur-sm p-4 rounded-lg border border-gold/20 animate-pulse-subtle">
                <p className="text-2xl md:text-3xl font-serif font-semibold text-gold">10+</p>
                <p className="text-sm uppercase tracking-wider mt-1">Luxury Amenities</p>
              </div>
              <div className="bg-gold/10 backdrop-blur-sm p-4 rounded-lg border border-gold/20 animate-pulse-subtle">
                <p className="text-2xl md:text-3xl font-serif font-semibold text-gold">4 & 5 BHK</p>
                <p className="text-sm uppercase tracking-wider mt-1">Premium Villas</p>
              </div>
              <div className="bg-gold/10 backdrop-blur-sm p-4 rounded-lg border border-gold/20 animate-pulse-subtle">
                <p className="text-2xl md:text-3xl font-serif font-semibold text-gold">15 Min</p>
          ...
          <div className="lg:col-span-2 animate-fade-in-right mx-auto w-full max-w-md">
            <div className="bg-white rounded-lg shadow-xl p-6 md:p-8 border-t-4 border-gold">
              <h3 className="font-serif text-2xl font-semibold text-gold-dark mb-6 text-center">Schedule Your Private Tour</h3>
              <ContactForm />
            </div>
          </div>
        </div>
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 z-10 text-white cursor-pointer" onClick={scrollToNextSection}>
        <div className="flex flex-col items-center">
          ...
          <div className="w-10 h-10 bg-gold/50 backdrop-blur-sm rounded-full flex items-center justify-center animate-bounce">
            <ChevronDown size={24} />
          </div>
        </div>
      </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fade-in">
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-md relative overflow-hidden animate-scale-in">
            <div className="bg-gold py-4 px-6">
              <h3 className="text-navy-dark font-serif text-2xl font-bold text-center">Download Exclusive Brochure</h3>
            </div>
            ...
            <div className="p-6">
              <p className="text-navy-light mb-6 text-center">
