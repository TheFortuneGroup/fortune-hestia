...
const CtaSection = () => {
  ...
  return (
    <section className="relative py-16 md:py-24">
      ...
      >
        <div className="absolute inset-0 bg-gold-dark/80"></div>
      </div>
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-4 md:gap-6 animate-slide-up">
            <Button className="bg-gold hover:bg-gold-light text-navy-dark px-8 py-6 text-lg rounded-md flex items-center gap-2 shadow-lg transition-all duration-300 transform hover:scale-105 w-full md:w-auto">
              Book a Site Visit
              <ArrowRight size={18} />
            </Button>
          ...
          <p className="mt-8 md:mt-10 text-gray-200 animate-slide-up">
            Contact us at <a href="tel:+919876543210" className="text-gold-light hover:underline font-medium">+91 98765 43210</a> or 
            <a href="mailto:dm@fortunehestia.in" className="text-gold-light hover:underline font-medium"> dm@fortunehestia.in</a>
          </p>
        </div>
      </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fade-in">
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-md relative overflow-hidden animate-scale-in">
            <div className="bg-gold py-4 px-6">
              <h3 className="text-navy-dark font-serif text-2xl font-bold">Download Exclusive Brochure</h3>
            </div>
